...
from autoop.core.ml.model.model import KNearestNeighbors,DecisionTreeClassifierModel, MLPClassifierModel, MultipleLinearRegression, LassoModel, RadiusNeighborsModel
...
- Take care of creating a specific model and fitting it instead of training it on specific features
...
# Step 4: Model Selection as a placeholder for model initialization based on task type
...
st.write(f"Training Data: {split_ratio * 100}%, Testing Data: {(1 - split_ratio) * 100}%")
...
if task_type == 'classification':
    ...
    available_metrics = ['Mean Squared Error', 'R squared', 'Mean Absolute Error']
selected_metrics = st.multiselect('Choose Metrics to Evaluate', options=available_metrics, default=available_metrics[0])
